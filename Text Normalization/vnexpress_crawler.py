...
class Extract_Text:
    def get_text_from_url(self, url_list):
        ...
        for page in url_list:
            ...
            full_text_content.append(title)
            full_text_content.append(descr)

            for paragraph in paragraphs:
                full_text_content.append(paragraph.text)

        full_text = " ".join(full_text_content)
        return full_text
    ...
    def get_text_from_view(self, view_url):
        ...
        full_text_content = [paragraph.text for paragraph in paragraphs]
        full_text_content.append(title)
...
if __name__ == "__main__":
    # Output path
    out_path = "/Users/macbook/Desktop/Everything Deep Learning/FPT.AI 2020/Text Normalization/raw_text_vnexpress.txt"
    ...
    raw_text = top_text + sub_text + view_text + left_text + right_text + below_text
