...
if __name__ == "__main__":
    ...
    # print(pd.DataFrame(top_text))
    # print(pd.DataFrame(sub_text))
    # print(pd.DataFrame(view_text))
    # print(pd.DataFrame(left_text))
    # print(pd.DataFrame(right_text))
    # print(pd.DataFrame(below_text))